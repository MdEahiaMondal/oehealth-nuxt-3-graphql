...
# from common.models import MultiLanguage
...
class User(AbstractUser, BaseModel):
    first_name = models.CharField(_('First name'), null=True, blank=True, max_length=150)
    last_name = models.CharField(_('Last name'), null=True, blank=True, max_length=150)
    name = models.CharField(_('Name'), null=True, blank=True, max_length=150)
    username = models.CharField(_('Username'), null=True, blank=True, unique=True, max_length=30)
    email = models.EmailField(_('Email'), null=True, blank=True, unique=True, max_length=50)
    USERNAME_FIELD = "username"
    EMAIL_FIELD = "email"
    gender = models.CharField(max_length=1, choices=GENDER_CHOICES, null=True, blank=True)
    phone = models.CharField(_('Phone'), null=True, blank=True, unique=True, max_length=10)
    ...
    street2 = models.CharField(_('Street 2'), max_length=150, blank=True, null=True)
    ...
    lang = models.ForeignKey("MultiLanguage", on_delete=models.CASCADE, null=True, blank=True)
...
class UserLang(models.Model):
    lang = models.ForeignKey(MultiLanguage, on_delete=models.CASCADE, blank=True, null=True)
