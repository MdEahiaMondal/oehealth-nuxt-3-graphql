...
class BaseModel(models.Model):
    ...
    created_by = models.ForeignKey('api.User', related_name='+', null=True, blank=True, on_delete=models.SET_NULL)
    last_updated_by = models.ForeignKey('api.User', related_name='+', null=True, blank=True, on_delete=models.SET_NULL)
    last_updated = models.PositiveBigIntegerField(editable=False, default=0)
    is_active = models.BooleanField(default=True)
    is_deleted = models.BooleanField(default=False)
    is_approved = models.BooleanField(default=False)
    last_approved_by = models.ForeignKey('api.User', related_name='+', null=True, blank=True, on_delete=models.SET_NULL)
    type = models.CharField(max_length=200, default='')
    deleted_by = models.ForeignKey('api.User', related_name='+', null=True, blank=True, on_delete=models.SET_NULL)
