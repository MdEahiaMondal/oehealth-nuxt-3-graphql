...
from common.models import Tooth, Treatment, Diagnostic, Specialization, Priority, Company, QuestionResponse, Question, AppointmentCode
...
class AppointmentDetail(models.Model):
    ...
    # appointment_code = models.ManyToManyField(
    #     AppointmentCode,
    #     null=True, blank=True)
