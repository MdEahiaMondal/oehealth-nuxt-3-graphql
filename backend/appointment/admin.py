...
from . import views
from .models import (Appointment, AppointmentDetail,
                     AppointmentPriority, AppointmentSpecialization,
                     Disease, DiseaseAnswer, AppointmentFile,
                     Survey,SurveyQuestionResponse, AppointmentSurvey, AppointmentSurveyQuestionResponse,
                     SurveyQuestionRelation,SurveysQuestion,AppointmentLang,AppointmentShortCode
                     )
