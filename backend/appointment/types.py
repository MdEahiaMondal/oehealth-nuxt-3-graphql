...
from .models import (Appointment, AppointmentDetail, AppointmentPriority,
                     AppointmentSpecialization, AppointmentFile, Disease,
                     DiseaseAnswer, Survey, SurveysQuestion, SurveyQuestionResponse,
                     AppointmentSurvey, AppointmentSurveyQuestionResponse,
                     SurveyQuestionRelation, AppointmentLang, AppointmentShortCode, )
